...
public class MapActivity_4 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //定义标记坐标点
        //第一个参数为纬度，第二个参数为经度
        LatLng point = new LatLng(39.08594, 122.00715);
        ...
        TitleOptions titleOptions = new TitleOptions().text("大连海昌发现王国").titleFontSize(30).titleFontColor(0xFF000000).titleOffset(0,150);
