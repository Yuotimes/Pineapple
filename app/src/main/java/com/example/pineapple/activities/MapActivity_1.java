...
public class MapActivity_1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //定义标记坐标点
        //第一个参数为纬度，第二个参数为经度
        LatLng point = new LatLng(38.88304, 121.61584);
        ...
        TitleOptions titleOptions = new TitleOptions().text("大连森林动物园").titleFontSize(30).titleFontColor(0xFF000000).titleOffset(0,150);
