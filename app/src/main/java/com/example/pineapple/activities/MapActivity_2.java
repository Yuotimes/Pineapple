...
public class MapActivity_2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //定义标记坐标点
        //第一个参数为纬度，第二个参数为经度
        LatLng point = new LatLng(38.88466, 121.68385);
        ...
        TitleOptions titleOptions = new TitleOptions().text("大连老虎滩海洋公园").titleFontSize(30).titleFontColor(0xFF000000).titleOffset(0,150);
