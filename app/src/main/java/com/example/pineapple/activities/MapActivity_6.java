...
public class MapActivity_6 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //定义标记坐标点
        //第一个参数为纬度，第二个参数为经度
        LatLng point = new LatLng(38.92999, 121.64600);
        ...
        TitleOptions titleOptions = new TitleOptions().text("盛世东方").titleFontSize(30).titleFontColor(0xFF000000).titleOffset(0,150);
